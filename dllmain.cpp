...
void gaybow(ImGuiWindow& window) {
	...
	//DrawWaterMark(window, "DecoWare is Sexy", ImVec2(50, 100), RGB, false);
...
void annoyingshit(ImGuiWindow& window) {
	auto RGB = ImGui::GetColorU32({ color_red, color_green, color_blue, 255 });
	DrawWaterMark(window, "", ImVec2(50, 100), RGB, false);
}
...
VOID MenuAndDestroy(ImGuiWindow& window) {
	...
	if (ShowMenu) {
		...
		if (ImGui::Begin(xorstr("DecoWare Internal Free"), &ShowMenu, ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoCollapse )) {
